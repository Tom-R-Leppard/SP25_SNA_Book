...
|--------------------------------------|----------------------------------|
| [Data Exploration](A3_Data Exploration.qmd) | Students will give descriptions of the network data they are using. They will discuss possible transformations to the data that they will need to perform before analysing. They may also provide basic visualisations to demonstrate this. |
