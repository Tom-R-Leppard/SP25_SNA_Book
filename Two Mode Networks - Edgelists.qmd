...
This is a continuation of the previous section working with two mode networks. The same learning elements apply here as applied in [Chapter 7](Two%20Mode%20Networks%20-%20AM.qmd).
...
Now we have changed it into a two mode network and added the characteristic "type" that we are familiar with from working with an adjacency matrix like we did in [Chapter 7](Two%20Mode%20Networks%20-%20AM.qmd).
